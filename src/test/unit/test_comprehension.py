class TestComprehension():
    ...
    def test_if_number_is_in_primes_set(self):        
        assert 37 in {
            num #expression
    ...
    def test_if_name_is_in_capitalized_set(self):
    ...
    def test_if_initials_are_in_set(self):
    ...
    def test_modify_value_in_dictionary(self):
        original_dic = [("a",1),("b",2),("c",3)]
        dicc = {k: self.double(v) for k,v in original_dic}
